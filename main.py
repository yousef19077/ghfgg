	...
	def my_function():
	  ...
	  "timer": "none",
		...
		if BL == '𝗙𝗥𝗘𝗘':	
			...
			ahmed = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/VAN990")
			contact_button = types.InlineKeyboardButton(text="✨ BUY  ✨", url="https://t.me/VAN_990")
...
للشراء عن طريق اسياسيل من هنا : @wwpww6
...
User Bot : @wwpww6 {BL}</b>
	''',reply_markup=keyboard)
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥 ✨", url="https://t.me/wwpww6")
		ahmed = types.InlineKeyboardButton(text="✨ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 ✨", url="https://t.me/reeetere")
		keyboard.add(contact_button, ahmed)
...
''',reply_markup=keyboard)
		...
		try:
			...
			keyboard = types.InlineKeyboardMarkup()
			ahmed = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/wwpww6")
			contact_button = types.InlineKeyboardButton(text="✨ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇  ✨", url="https://t.me/wwpww6")
			keyboard.add(contact_button, ahmed)
			bot.send_message(chat_id=message.chat.id, text=f'''<b>مرحبا {name}
عذرا هذا البوت ليس مجانا 
...
''',reply_markup=keyboard)
		...
		if current_time - provided_time > required_duration:
			keyboard = types.InlineKeyboardMarkup()
			ahmed = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/wwpww6")
			contact_button = types.InlineKeyboardButton(text="✨ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇  ✨", url="https://t.me/reeetere")
			keyboard.add(contact_button, ahmed)
			...
			with open("combo.txt", 'r') as file:
				...
				for cc in lino:
					if stopuser[f'{id}']['status'] == 'stop':
						bot.edit_message_text(chat_id=call.chat.id, message_id=ko, text='تم الايقاف بنجاح مالك البوت  @wwpww6')
						return
					try:
...
مالك البوت @wwpww6''', reply_markup=mes)
...
✪ 𝙼𝙰𝙳𝙴 𝚆𝙸𝚃𝙷 𝙱𝚈 ➔ @wwpww6  
		...
		bot.edit_message_text(chat_id=call.message.chat.id, 
					  message_id=call.message.message_id, 
					  text='تم الانتهاء من الفحص مالك البوت @wwpww6')
	my_thread = threading.Thread(target=my_function)
	my_thread.start()
...
✪ 𝙼𝙰𝙳𝙴 𝚆𝙸𝚃𝙷 𝙱𝚈 ➔ @wwpww6  
		...
		bot.edit_message_text(chat_id=call.message.chat.id, 
					  message_id=call.message.message_id, 
					  text='تم الانتهاء من الفحص بنجاح مالك البوت @wwpww6')
	my_thread = threading.Thread(target=my_function)
	my_thread.start()
...
def respond_to_vbv(message):
  ...
  "timer": "none",
	...
	if BL == '𝗙𝗥𝗘𝗘':
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="@wwpww6")
		ahmed = types.InlineKeyboardButton(text="✨ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇  ✨", url="https://t.me/reeetere")
		keyboard.add(contact_button, ahmed)
		bot.send_message(chat_id=message.chat.id, text=f'''<b>مرحبا {name}
عذرا هذا البوت ليس مجانا 
...
To purchase via USDT from here : @wwpww6
User Bot : @wwpww6 {BL}</b><b>مرحبا {name}
عذرا هذا البوت ليس مجانا 
